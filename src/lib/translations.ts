...
export const translations = {
  es: {
    ...
    pricingPage: {
      ...
      groupsDesc: "¿Son más de 6 personas? Consulta por tarifas especiales para grupos cerrados."
    },
    safety: {
    ...
    faqPage: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Si se cancela o juega sin público, ofrecemos reprogramación o reembolso del 100%."
        },
        {
    ...
    contactPage: {
      title: "Contacto",
      subtitle: "¿Tienes una solicitud especial o quieres reservar para un grupo? Estamos aquí para ayudar.",
      cardTitle: "Respuesta rápida",
      cardDesc: "Estamos disponibles de Lunes a Sábado de 9 AM a 8 PM.",
      cta: "Chatea con nosotros",
      email: "Email: contacto@kusi.pe",
      ...
      sections: [
        {
          ...
          content: "KUSI Fútbol Tours es una agencia de servicios de logística y acompañamiento deportivo."
        }
      ]
    },
    privacyPage: {
    ...
    hostelsPage: {
      ...
      benefits: ["Comisión por referido", "Recojo directo", "Material promocional", "Atención VIP"],
      cta: "Quiero ser Partner"
    },
    footer: {
      description: "Vive la pasión del fútbol peruano con seguridad y comodidad.",
      company: "Empresa",
      legal: "Legal",
      terms: "Términos",
      privacy: "Privacidad",
  ...
  en: {
    ...
    experiencePage: {
      ...
      logisticsDesc: "We take care of everything: from the moment we pick you up at the meeting point until you return home. Our bilingual team will accompany you every step of the way to ensure an unforgettable experience.",
    ...
    pricingPage: {
      ...
      paymentNote: "We accept local apps and bank transfers.",
      infoTitle: "Payment Info",
      reservaTitle: "100% Prepayment",
      reservaDesc: "Due to high demand, spots are confirmed only after full payment.",
      groupsTitle: "Large Groups",
      groupsDesc: "More than 6 people? Ask for special private group rates."
    },
    safety: {
    ...
    faqPage: {
      ...
      items: [
        {
          question: "Is it safe?",
          answer: "Absolutely. Safety is our priority with private transport and constant guidance."
        },
        {
          question: "Match cancellation?",
          answer: "We offer rescheduling or 100% refund."
        },
        {
          question: "Lateness?",
    ...
    contactPage: {
      title: "Contact Us",
      subtitle: "Have a special request? We are here to help.",
      cardTitle: "Quick Response",
      cardDesc: "Available Mon-Sat, 9 AM to 8 PM.",
      cta: "Chat with us",
      email: "Email: contacto@kusi.pe",
      location: "Location: Lima, Peru"
    },
    termsPage: {
      title: "Terms & Conditions",
      sections: [{ title: "1. Service Nature", content: "KUSI is a logistics agency." }]
    },
    privacyPage: {
    ...
    hostelsPage: {
      ...
      benefits: ["Commission", "Direct pickup", "Promo material", "VIP attention"],
      cta: "Become a Partner"
    },
    footer: {
      description: "Experience Peruvian football with safety and comfort.",
      company: "Company",
      legal: "Legal",
      terms: "Terms",
      privacy: "Privacy",
